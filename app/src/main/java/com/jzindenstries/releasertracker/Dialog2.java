...
public class Dialog2 {
    ...
    public void showDialog2(Activity activity, ArrayList<GoToHouse> dataHouse){
        ...
        Amount.setText("כמות מנתקים כוללת:  "+dataHouse.size());
        ...
        for(GoToHouse goToHouse : dataHouse){
            if(goToHouse.getType().contains("FXC")){ counterType[0]++;}
            if(goToHouse.getType().contains("5000")){ counterType[1]++;}
            if(goToHouse.getType().contains("M1")){ counterType[2]++;}
            if(goToHouse.getType().contains("M2")){ counterType[3]++;}
            if(goToHouse.getType().contains("K35")){ counterType[4]++;}
        }
        pieArrayList();
